// src/components/AboutAryaSamaj.tsx
import { Badge } from "@/components/ui/badge";
import { TextGenerateEffect } from "./ui/text-generate-effect";

const AboutAryaSamaj = () => {
  const aboutText = "is a monotheistic Hindu reform movement founded by Maharshi Dayanand Saraswati in 1875. It emphasizes the infallible authority of the Vedas and promotes values of truth, righteousness, and social reform. The organization works towards the physical, social, and spiritual uplift of humanity through Vedic principles and practices.";
